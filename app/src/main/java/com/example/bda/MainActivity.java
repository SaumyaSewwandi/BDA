...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Little Help");
        ...
        nav_image = nav_view.getHeaderView(0).findViewById(R.id.nav_user_image);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()){
                    ...
                    if(snapshot.hasChild("profilepictureurl")) {
                        ...
                        Glide.with(getApplicationContext()).load(imageUrl).into(nav_image);
                    }
                    else{
                        nav_image.setImageResource(R.drawable.profile_image);
                    }
    ...
    private void readDonor() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(userList.isEmpty()){
                    Toast.makeText(MainActivity.this, "No Donores", Toast.LENGTH_SHORT).show();
                    progressBar.setVisibility(View.GONE);
                }
            }
